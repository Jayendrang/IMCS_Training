package Assignment17DynamicBinding;
...
public class Assignment15DynamicBinding {

//	public void transaction(Account acc,double amt) {
//		acc.deposit(amt);
//	}
	
	public static void transaction(Account acc,double amt) {
	acc.deposit(amt);
	acc.withdraw(amt);
	}
	...
	public static void main(String[] args) {
		...
		Assignment15DynamicBinding.transaction(jennyOdA, 200);
		System.out.println("Overdraft a/c Balance \t$" + jennyOdA.balanceEnquiry());
